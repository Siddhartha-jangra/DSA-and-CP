/*
what i will do is i will remove one letter from the front and put it at the end and then check it the other string is a substring of the new formed string 
this approach did not is not the perfect solution
the hint given was to solve the appending the x about 5 times and then checking it across each of them. my question is why?
